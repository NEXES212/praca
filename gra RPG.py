...
gra = input("Omówienie ")
if gra == "1":
    print("Witaj aby wygrać musisz dokonywać własciwych wyborów jeśli wybierzesz źle tracisz życie na poziomie łatwtym masz 3 życia będziessz miał/a do wyboru od 2 do 4 opcji jeśli wybierzesz żle tracisz życie ")
if gra == "2":
    print("Witaj aby wygrać musisz dokonywać własciwych wyborów jeśli wybierzesz źle tracisz życie na poziomie Normalnym masz 2 życia będziessz miał/a do wyboru od 2 do 4 opcji jeśli wybierzesz żle tracisz życie ")
if gra == "3":
    print("Witaj aby wygrać musisz dokonywać własciwych wyborów jeśli wybierzesz źle tracisz życie na poziomie Trudnym masz 1 życia będziessz miał/a do wyboru od 2 do 4 opcji jeśli wybierzesz żle tracisz życie")
...
if decyzja == "1":
    print("wygrałeś i masz teraz ")
    life -= 16
    mana -= 30
    money += 120

elif decyzja =="2":
    print("spotykasz na innej drodze bandytów")
    life -= 24
    mana -= 70
    money -= 200

elif  decyzja =="3":
    print("w lesie znajdujesz worek z mnetami lecz kaleczysz się cierniami")
    life -= 10
    money += 150
...
(name + " wyjechałeś z wioski ale kiedy przejerzdrzałeś przez most zaatakował cię smok morski")
...
if Ostatnia_walka =="1":
   print("Zabiłeś potowy ale czrnoksięznik przerzył")
   life -= 0
   mana -= 50
   money += 300
